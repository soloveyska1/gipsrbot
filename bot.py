...
ORDER_TYPES = {
    ...
    'kursovaya_s_empirikov': {
        ...
        'icon': '📊',
        'description': 'Теория + данные и глубокий анализ. Клиенты говорят: "Лучшая помощь!" ⭐️',
        'details': (
            'Работаем с собранными данными или поможем организовать их сбор вместе с менеджером под вашу тему. '
            'Проводим опросы, расчёты и математическую статистику, оформляем таблицы, графики, приложения и рекомендации '
            'в соответствии с требованиями вуза.'
        ),
